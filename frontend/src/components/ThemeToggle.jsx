...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label
        className="flex items-center justify-center cursor-pointer w-8 h-8 bg-white hover:bg-white dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full"
      ...
      >
        <svg className="w-4 h-4 dark:hidden" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <path className="fill-current text-yellow-600" d="M8 4C5.8 4 4 5.8 4 8s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4Z" />
        </svg>
