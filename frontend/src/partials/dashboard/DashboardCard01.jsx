      ...
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          ...
          <EditMenu align="right" className="relative inline-flex">
            <li>
              <Link className="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex py-1 px-3" to="http://www.youtube.com">
                View more
              </Link>
            </li>
          </EditMenu>
