...
function DashBoardTwitterArticles({twitterArticles}) {

  let sum=0;
  twitterArticles.forEach(lec => {
    sum += lec;
  });
  const chartData = {
    labels: [
  ...
  // console.log(typeof(twitterArticles));
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">Number of Twitter Articles</h2>
        <div className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase mb-1">Twitter Articles</div>
...
export default DashBoardTwitterArticles;