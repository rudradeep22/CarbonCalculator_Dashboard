  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}w-48
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar  lg:w-20 lg:sidebar-expanded:!w-48 2xl:!w-48 shrink-0 bg-green-600 p-4 transition-all duration-200 ease-in-out dark:bg-indigo-700 ${
